...
const
     ...
     BondSymbol: array [BMin..BMax] of string[3]=('-','=','+','*','5','6','7','?','_','.',':','#','h','c','n','u','m','c','e','z','s','a','0>1','0>2','0>3','0>4','0>c','0>h','1>0','2>0','3>0','4>0','c>0','h>0','1>2','1>3','1>4','1>c','1>h','2>1','2>3','2>4','2>c','3>1','3>2','3>4','3>c','4>1','4>2','4>3','c>1','c>2','c>3','c>4','h>1','n>u','n>c','n>e','n>z','n>s','n>a','u>n','u>c','u>e','e>z','u>s','u>a','c>n','c>u','c>e','c>z','c>s','c>a','e>n','e>u','e>c','e>z','e>s','e>a','z>n','z>u','z>c','z>e','z>s','z>a','s>n','s>u','s>c','s>e','s>z','s>a','a>n','a>u','a>c','a>e','a>z','a>s','YY');
